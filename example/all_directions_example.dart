...
void main() => runApp(const AllDirectionsApp());

class AllDirectionsApp extends StatelessWidget {
  const AllDirectionsApp({super.key});

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: 'Edge Side Panel All Directions Demo',
      debugShowCheckedModeBanner: false,
      home: Scaffold(body: ScreenA()),
    );
  }
}
...
Widget buildWithSidePanel(
  ...
  return Stack(children: [
    ...
    EdgeSideBar(
      ...
      borderRadius: 36,
      backgroundColor: Colors.white.withOpacity(0.7),
      defaultToggleColor: const Color.fromARGB(255, 172, 216, 215),
      initialExpanded: false,
      children: [
        _SidebarIcon(
          path: 'assets/EdgeLighting+ - Good Lock.png',
